...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_StorageCache_2020_03_01
    {
        private const string ProviderNamespace = "Microsoft.StorageCache";
        private const string ApiVersion = "2020-03-01";
        ...
        private Microsoft_StorageCache_2020_03_01()
        {
            ...
            CacheNetworkSettings = new NamedObjectType("CacheNetworkSettings", new ITypeProperty[]{new TypeProperty("mtu", LanguageConstants.Int, TypePropertyFlags.None), new TypeProperty("utilityAddresses", new TypedArrayType(LanguageConstants.String), TypePropertyFlags.ReadOnly)}, null);
            CacheEncryptionSettings = new NamedObjectType("CacheEncryptionSettings", new ITypeProperty[]{new LazyTypeProperty("keyEncryptionKey", () => KeyVaultKeyReference, TypePropertyFlags.None)}, null);
            KeyVaultKeyReference = new NamedObjectType("KeyVaultKeyReference", new ITypeProperty[]{new TypeProperty("keyUrl", LanguageConstants.String, TypePropertyFlags.Required), new LazyTypeProperty("sourceVault", () => KeyVaultKeyReferenceSourceVault, TypePropertyFlags.Required)}, null);
            KeyVaultKeyReferenceSourceVault = new NamedObjectType("KeyVaultKeyReferenceSourceVault", new ITypeProperty[]{new TypeProperty("id", LanguageConstants.String, TypePropertyFlags.None)}, null);
            CacheSecuritySettings = new NamedObjectType("CacheSecuritySettings", new ITypeProperty[]{new TypeProperty("rootSquash", LanguageConstants.Bool, TypePropertyFlags.None)}, null);
            ...
            StorageTargetProperties = new DiscriminatedObjectType("StorageTargetProperties", "targetType", new ITypeProperty[]{new LazyTypeProperty("StorageTargetProperties", () => Nfs3TargetProperties, TypePropertyFlags.None), new LazyTypeProperty("StorageTargetProperties", () => ClfsTargetProperties, TypePropertyFlags.None), new LazyTypeProperty("StorageTargetProperties", () => UnknownTargetProperties, TypePropertyFlags.None)});
        ...
        private readonly TypeSymbol CacheIdentity;
        ...
        private readonly TypeSymbol CacheNetworkSettings;
        private readonly TypeSymbol CacheEncryptionSettings;
        private readonly TypeSymbol KeyVaultKeyReference;
        private readonly TypeSymbol KeyVaultKeyReferenceSourceVault;
        private readonly TypeSymbol CacheSecuritySettings;
        ...
        private readonly TypeSymbol Nfs3TargetProperties;
        private readonly TypeSymbol ClfsTargetProperties;
        private readonly TypeSymbol UnknownTargetProperties;
    }
}
