...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_ContainerInstance_2018_06_01
    {
        ...
        private Microsoft_ContainerInstance_2018_06_01()
        {
            ...
            LogAnalytics = new NamedObjectType("LogAnalytics", new ITypeProperty[]{new TypeProperty("workspaceId", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("workspaceKey", LanguageConstants.String, TypePropertyFlags.Required)}, null);
