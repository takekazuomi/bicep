...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_ContainerService_2016_03_30
    {
        ...
        private Microsoft_ContainerService_2016_03_30()
        {
            ...
            ContainerServiceOrchestratorProfile = new NamedObjectType("ContainerServiceOrchestratorProfile", new ITypeProperty[]{new TypeProperty("orchestratorType", UnionType.Create(new StringLiteralType("'Swarm'"), new StringLiteralType("'DCOS'")), TypePropertyFlags.Required)}, null);
