...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_ContainerService_2016_09_30
    {
        private const string ProviderNamespace = "Microsoft.ContainerService";
        private const string ApiVersion = "2016-09-30";
        ...
        private static Lazy<Microsoft_ContainerService_2016_09_30> InstanceLazy = new Lazy<Microsoft_ContainerService_2016_09_30>(() => new Microsoft_ContainerService_2016_09_30());
        private Microsoft_ContainerService_2016_09_30()
        {
            ContainerServiceProperties = new NamedObjectType("ContainerServiceProperties", new ITypeProperty[]{new TypeProperty("provisioningState", LanguageConstants.String, TypePropertyFlags.ReadOnly), new LazyTypeProperty("orchestratorProfile", () => ContainerServiceOrchestratorProfile, TypePropertyFlags.None), new LazyTypeProperty("customProfile", () => ContainerServiceCustomProfile, TypePropertyFlags.None), new LazyTypeProperty("servicePrincipalProfile", () => ContainerServiceServicePrincipalProfile, TypePropertyFlags.None), new LazyTypeProperty("masterProfile", () => ContainerServiceMasterProfile, TypePropertyFlags.Required), new LazyTypeProperty("agentPoolProfiles", () => new TypedArrayType(ContainerServiceAgentPoolProfile), TypePropertyFlags.Required), new LazyTypeProperty("windowsProfile", () => ContainerServiceWindowsProfile, TypePropertyFlags.None), new LazyTypeProperty("linuxProfile", () => ContainerServiceLinuxProfile, TypePropertyFlags.Required), new LazyTypeProperty("diagnosticsProfile", () => ContainerServiceDiagnosticsProfile, TypePropertyFlags.None)}, null);
            ContainerServiceOrchestratorProfile = new NamedObjectType("ContainerServiceOrchestratorProfile", new ITypeProperty[]{new TypeProperty("orchestratorType", UnionType.Create(new StringLiteralType("'Swarm'"), new StringLiteralType("'DCOS'"), new StringLiteralType("'Custom'"), new StringLiteralType("'Kubernetes'")), TypePropertyFlags.Required)}, null);
            ContainerServiceCustomProfile = new NamedObjectType("ContainerServiceCustomProfile", new ITypeProperty[]{new TypeProperty("orchestrator", LanguageConstants.String, TypePropertyFlags.Required)}, null);
            ContainerServiceServicePrincipalProfile = new NamedObjectType("ContainerServiceServicePrincipalProfile", new ITypeProperty[]{new TypeProperty("clientId", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("secret", LanguageConstants.String, TypePropertyFlags.Required)}, null);
            ...
            ContainerServiceDiagnosticsProfile = new NamedObjectType("ContainerServiceDiagnosticsProfile", new ITypeProperty[]{new LazyTypeProperty("vmDiagnostics", () => ContainerServiceVMDiagnostics, TypePropertyFlags.Required)}, null);
            ContainerServiceVMDiagnostics = new NamedObjectType("ContainerServiceVMDiagnostics", new ITypeProperty[]{new TypeProperty("enabled", LanguageConstants.Bool, TypePropertyFlags.Required), new TypeProperty("storageUri", LanguageConstants.String, TypePropertyFlags.ReadOnly)}, null);
            ResourceType_containerServices = new ResourceType("Microsoft.ContainerService/containerServices", new ITypeProperty[]{new TypeProperty("id", LanguageConstants.String, TypePropertyFlags.SkipInlining | TypePropertyFlags.ReadOnly), new TypeProperty("name", LanguageConstants.String, TypePropertyFlags.SkipInlining | TypePropertyFlags.Required), new TypeProperty("type", new StringLiteralType("'Microsoft.ContainerService/containerServices'"), TypePropertyFlags.SkipInlining | TypePropertyFlags.ReadOnly), new TypeProperty("location", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("tags", new NamedObjectType("tags", new ITypeProperty[]{}, new TypeProperty("additionalProperties", LanguageConstants.String, TypePropertyFlags.None)), TypePropertyFlags.None), new LazyTypeProperty("properties", () => ContainerServiceProperties, TypePropertyFlags.Required), new TypeProperty("apiVersion", new StringLiteralType("'2016-09-30'"), TypePropertyFlags.SkipInlining | TypePropertyFlags.ReadOnly), new TypeProperty("dependsOn", new TypedArrayType(LanguageConstants.ResourceRef), TypePropertyFlags.WriteOnly)}, null, ResourceTypeReference_containerServices);
        }
