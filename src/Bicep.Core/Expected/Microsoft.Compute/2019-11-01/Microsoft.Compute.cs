...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_Compute_2019_11_01
    {
        ...
        private static Lazy<Microsoft_Compute_2019_11_01> InstanceLazy = new Lazy<Microsoft_Compute_2019_11_01>(() => new Microsoft_Compute_2019_11_01());
        private Microsoft_Compute_2019_11_01()
        {
            ...
            SnapshotProperties = new NamedObjectType("SnapshotProperties", new ITypeProperty[]{new TypeProperty("osType", LanguageConstants.String, TypePropertyFlags.None), new TypeProperty("hyperVGeneration", LanguageConstants.String, TypePropertyFlags.None), new LazyTypeProperty("creationData", () => CreationData, TypePropertyFlags.Required), new TypeProperty("diskSizeGB", LanguageConstants.Int, TypePropertyFlags.None), new LazyTypeProperty("encryptionSettingsCollection", () => EncryptionSettingsCollection, TypePropertyFlags.None), new TypeProperty("incremental", LanguageConstants.Bool, TypePropertyFlags.None), new LazyTypeProperty("encryption", () => Encryption, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
            ...
            EncryptionSetProperties = new NamedObjectType("EncryptionSetProperties", new ITypeProperty[]{new LazyTypeProperty("activeKey", () => KeyVaultAndKeyReference, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
