...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_DataBox_2019_09_01
    {
        ...
        private Microsoft_DataBox_2019_09_01()
        {
            ...
            Preferences = new NamedObjectType("Preferences", new ITypeProperty[]{new TypeProperty("preferredDataCenterRegion", LanguageConstants.Array, TypePropertyFlags.None), new LazyTypeProperty("transportPreferences", () => TransportPreferences, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
