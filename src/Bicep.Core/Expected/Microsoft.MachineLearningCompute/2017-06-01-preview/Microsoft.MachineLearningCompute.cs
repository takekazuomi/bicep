...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_MachineLearningCompute_2017_06_01_preview
    {
        ...
        private Microsoft_MachineLearningCompute_2017_06_01_preview()
        {
            ...
            KubernetesClusterProperties = new NamedObjectType("KubernetesClusterProperties", new ITypeProperty[]{new LazyTypeProperty("servicePrincipal", () => ServicePrincipalProperties, TypePropertyFlags.Required)}, null, TypePropertyFlags.None);
            ...
            AppInsightsCredentials = new NamedObjectType("AppInsightsCredentials", new ITypeProperty[]{new TypeProperty("appId", LanguageConstants.String, TypePropertyFlags.None), new TypeProperty("apiKey", LanguageConstants.String, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
