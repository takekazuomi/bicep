...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_ContainerInstance_2017_10_01_preview
    {
        ...
        private Microsoft_ContainerInstance_2017_10_01_preview()
        {
            ...
            Volume = new NamedObjectType("Volume", new ITypeProperty[]{new TypeProperty("name", LanguageConstants.String, TypePropertyFlags.Required), new LazyTypeProperty("azureFile", () => AzureFileVolume, TypePropertyFlags.None), new TypeProperty("emptyDir", LanguageConstants.Any, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
