...
namespace Bicep.Resources.Types
{
    ...
    public class Microsoft_ContainerInstance_2019_12_01
    {
        ...
        private Microsoft_ContainerInstance_2019_12_01()
        {
            ...
            ContainerGroupProperties = new NamedObjectType("ContainerGroupProperties", new ITypeProperty[]{new TypeProperty("containers", LanguageConstants.Array, TypePropertyFlags.Required), new TypeProperty("imageRegistryCredentials", LanguageConstants.Array, TypePropertyFlags.None), new TypeProperty("restartPolicy", LanguageConstants.String, TypePropertyFlags.None), new LazyTypeProperty("ipAddress", () => IpAddress, TypePropertyFlags.None), new TypeProperty("osType", LanguageConstants.String, TypePropertyFlags.Required), new TypeProperty("volumes", LanguageConstants.Array, TypePropertyFlags.None), new LazyTypeProperty("diagnostics", () => ContainerGroupDiagnostics, TypePropertyFlags.None), new LazyTypeProperty("networkProfile", () => ContainerGroupNetworkProfile, TypePropertyFlags.None), new LazyTypeProperty("dnsConfig", () => DnsConfiguration, TypePropertyFlags.None), new TypeProperty("sku", LanguageConstants.String, TypePropertyFlags.None), new LazyTypeProperty("encryptionProperties", () => EncryptionProperties, TypePropertyFlags.None), new TypeProperty("initContainers", LanguageConstants.Array, TypePropertyFlags.None)}, null, TypePropertyFlags.None);
            ...
            InitContainerDefinition = new NamedObjectType("InitContainerDefinition", new ITypeProperty[]{new TypeProperty("name", LanguageConstants.String, TypePropertyFlags.Required), new LazyTypeProperty("properties", () => InitContainerPropertiesDefinition, TypePropertyFlags.Required)}, null, TypePropertyFlags.None);
